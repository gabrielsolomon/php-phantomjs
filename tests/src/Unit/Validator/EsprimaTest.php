...
/** +++++++++++++++++++++++++++++++++++ **/
    ...
    public function testEngineCanBeLoaded()
    {
        ...
        static::assertStringContainsString('esprima', $esprima->load());
    }
    ...
    public function testEngineCanBeCovertedToString()
    {
       $fileLocator = $this->getFileLocator();
        ...
        static::assertStringContainsString('esprima', (string) $esprima);
    }
...
/** +++++++++++++++++++++++++++++++++++ **/
    ...
    protected function getFileLocator()
    {
        $fileLocator = new FileLocator(
            sprintf('%s/../../../../src/Resources/validators/', __DIR__)
        );
