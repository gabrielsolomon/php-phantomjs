...
/** +++++++++++++++++++++++++++++++++++ **/
    ...
    {
        $this->expectException(\JonnyW\PhantomJs\Exception\InvalidExecutableException::class);
    ...
    public function testDefaultPhantomJSPathIsReturnedIfNoCustomPathIsSet()
    {
        ...
        $this->assertStringContainsString('phantomjs', $engine->getPath());
    }
    ...
    public function testCanLogData()
    {
        ...
        static::assertSame($log, $engine->getLog());
    }
    ...
    public function testCanAddRunOption()
    {
        ...
        static::assertSame($options, $engine->getOptions());
    }
    ...
    public function testCommandContainsPhantomJSExecutable()
    {
        ...
        static::assertStringContainsString($engine->getPath(), $engine->getCommand());
    }
    ...
    public function testDebugFlagCanBeSet()
    {
        ...
        static::assertStringContainsString('--debug=true', $engine->getCommand());
    }
    ...
    public function testDiskCacheFlagCanBeSet()
    {
        ...
        static::assertStringContainsString('--disk-cache=true', $engine->getCommand());
    }
    ...
    public function testCommandContainsRunOptions()
    {
        ...
        static::assertStringContainsString($option1, $command);
        static::assertStringContainsString($option2, $command);
        static::assertStringContainsString($option3, $command);
    }
    ...
    public function testDebugFlagIsSetIfRunOptionsAreAlsoSet()
    {
        ...
        static::assertStringContainsString($option, $command);
        static::assertStringContainsString('--debug=true', $command);
    }
